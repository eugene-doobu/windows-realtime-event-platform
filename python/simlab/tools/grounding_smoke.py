...
from simlab.config import load_grounding_settings
from simlab.runner.execution import RunMode
from simlab.runner.launch import bootstrap_run
...
def main() -> int:
    ...
    if not settings.postgres_dsn:
        raise SystemExit("SIMLAB_RAG_POSTGRES_DSN is not configured.")
